...
class TestPlanner:
    def __init__(self, planner_class: Type = None):
        ...
        # Define static box obstacles
        self.static_obstacles = [
            np.array([-5, -5, 0, -3, -3, 4]),  # Box obstacle 1
            np.array([3, 3, 0, 5, 5, 6]),  # Box obstacle 2
            np.array([-2, 2, 0, 0, 4, 3]),  # Box obstacle 3
        ]
