...
if __name__ == "__main__":
    ...
    obstacles = np.array([
        # All structures treated as buildings (8-10 units high)
        ...
        [6, -8, 0, 8, -6, 9.2],      # Building 8 (9.2 units)
        [7, -3, 0, 9, -1, 8.8],      # Building 9 (8.8 units)
        [-7, -4, 0, -5, -2, 9.7],    # Building 10 (9.7 units)
        [1, 1, 0, 3, 3, 9.4],        # Building 11 (9.4 units)
        [-9, 0, 0, -7, 2, 8.9],      # Building 12 (8.9 units)
        [5, -7, 0, 7, -5, 9.1],      # Building 13 (9.1 units)
        [-2, -7, 0, 0, -5, 8.6],     # Building 14 (8.6 units)
        [3, 6, 0, 5, 8, 9.3]         # Building 15 (9.3 units)
    ])
